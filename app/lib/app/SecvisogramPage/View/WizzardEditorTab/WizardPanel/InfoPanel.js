...
/**
 * Defines the content of the info panel displaying documentation of a selected path
 *
 * @param {{
 *   selectedPath: string
 * }} props
...
export default function InfoPanel({selectedPath}) {
  ...
  return <div className="helpContent" dangerouslySetInnerHTML={{ __html: marked(mdText) }}/>
}
