...
The secvisogram provides some very basic templates. You can use your own templates by saving them as json files on your filesystem and load using the "Open" feature of the editor.
